const people =[
    ...
    { firstName: 'Chester', lastName: 'Flores', DOB: '03/15/1958', department: 'Development', salary: '41000' },
...
console.log(people.filter(person => new Date().getFullYear() - new Date(person.DOB).getFullYear() > 40));
